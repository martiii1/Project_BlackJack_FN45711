...
public:
    ...
    int draw(); // This is the suit_count function form the tasks given. The drawn card is put on the end of the deck.
...
private:
    ...
    char* newSerialNumber(); // every call gets a unique card ID
